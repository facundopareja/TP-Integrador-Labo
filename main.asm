...
PORT_INITIALIZING:
	...
	out DDRD, temp 								;bits 4-7, puerto D como salida

	in temp, PORTD
	andi temp, ~msk_entrada						;salidas en 0
	out PORTD, temp

	in temp, DDRC
	andi temp, msk_entrada
	out DDRC, temp 								;bits 0-3, puerto C como entrada

	in temp, PORTC
	ori temp, ~msk_entrada
	out PORTC, temp 							;entradas en pull-up
...
INICIALIZACION_PC:
	...
	lds temp, PCICR
	ori temp, (1<<PCIE1)
	sts PCICR, temp								;habilito la interrupcion de PC para el puerto C
